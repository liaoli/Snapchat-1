...
public class ColorAdapter extends RecyclerView.Adapter<ColorAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        Picasso.with(mContext).load(mDataSet[position]).into(holder.imageView);

//        holder.imageView.setText(mDataSet[position]);
        // Set a random height for TextView
//        holder.imageView.getLayoutParams().height = getRandomIntInRange(250,75);

        // Set a random color for TextView background
//        holder.imageView.setBackgroundColor(getRandomHSVColor());
    }
